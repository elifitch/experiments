...
const triangleArea = makeTriangleArea();


// Merge two geometries or geometry and geometry from object (using object's transform)
function merge(geometry1, geometry2, materialIndexOffset) {
...
function makeRandomPointInTriangle() {
...
const randomPointInTriangle = makeRandomPointInTriangle();
...
function randomPointsInBufferGeometry(geometry, n) {
  ...
  for (i = 0; i < n; i++) {
    ...
    result[i] = {
      position: randomPointInTriangle(vA, vB, vC),
      normal: computeFaceNormal(vA, vB, vC)
    };
